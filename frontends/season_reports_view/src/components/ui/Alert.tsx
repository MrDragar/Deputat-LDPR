...
const alertConfig = {
  ...
  info: {
    ...
    focusRingOffsetClass: 'focus:ring-offset-blue-600',
  },
};
      ...
      <div className="flex items-start">
        ...
        <div className="ml-auto pl-3 flex-shrink-0">
          <button
            type="button"
            onClick={handleClose}
            className={`inline-flex rounded-full p-1.5 text-white hover:bg-white/20 focus:outline-none focus:ring-2 focus:ring-white cursor-pointer ${focusRingOffsetClass}`}
          >
