        ...
        <div className="relative p-4 sm:p-6">
          ...
          <div className="mt-6 flex flex-col-reverse gap-3">
            <button
              type="button"
              onClick={onClose}
              className="w-full px-6 py-3 text-base font-semibold rounded-lg transition-all bg-gray-100 text-gray-700 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 cursor-pointer"
            >
              Отмена
            </button>
            <button
              type="button"
              onClick={onConfirm}
              className={`w-full px-6 py-3 text-base font-semibold rounded-lg transition-all shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2 cursor-pointer ${buttonClasses}`}
            >
              {confirmButtonText}
            </button>
          </div>
