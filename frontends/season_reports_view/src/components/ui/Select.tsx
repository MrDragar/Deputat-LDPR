      ...
      <div className="relative">
        ...
        <div className="relative">
          ...
          <button
            ...
            className={`w-full py-3 pr-4 text-left bg-white border rounded-md shadow-sm flex justify-between items-center text-base cursor-pointer
    ...
    <div ref={wrapperRef} className="relative">
      ...
      <div className="relative">
        ...
        <button
          ...
          className={`w-full h-[42px] pr-4 text-left bg-white border rounded-lg shadow-sm flex justify-between items-center text-base cursor-pointer
