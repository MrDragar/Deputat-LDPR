...
export const Calendar: React.FC<CalendarProps> = ({
  ...
  return (
    <div className={`p-4 bg-white rounded-lg w-full ${className}`}>
      <div className="flex justify-between items-center mb-4">
        {showNavigation ? (
          <button type="button" onClick={prevMonth} className="p-2 rounded-full hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500 cursor-pointer">
        ...
        {showNavigation ? (
          <button type="button" onClick={nextMonth} className="p-2 rounded-full hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500 cursor-pointer">
      ...
      <div className="grid grid-cols-7">
        {days.map(day => {
          ...
          let backgroundClasses = 'absolute inset-y-0 h-9 bg-blue-100';
          ...
          const buttonClasses = [
            'relative z-10 w-9 h-9 shrink-0',
            'flex items-center justify-center',
            'rounded-full',
            'text-sm transition-colors duration-150',
            'focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-blue-500 cursor-pointer',
            isDisabled
          ...
          return (
            <div key={day.toISOString()} className="relative flex justify-center items-center h-9">
