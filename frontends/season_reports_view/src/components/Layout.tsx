...
const Layout: React.FC<LayoutProps> = ({ children, showSidebar = false }) => {
  ...
  return (
      <div className="min-h-screen bg-gray-50 flex flex-col md:flex-row">
        ...
        {showSidebar && (
            <div
                className="md:hidden flex items-center justify-between p-4 border-b border-gray-200 bg-white">
              <button
                  className="p-2 -ml-2 text-gray-600 hover:bg-gray-100 rounded-lg transition-colors cursor-pointer">
