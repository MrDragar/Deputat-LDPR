# Generated by Django 5.1.3 on 2025-09-08 23:38
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('postgraduate_type', models.CharField(blank=True, choices=[('Аспирантура', 'Аспирантура'), ('Ординатура', 'Ординатура'), ('Докторантура', 'Докторантура')], max_length=100, verbose_name='Вид послевузовского образования')),
